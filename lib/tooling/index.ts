...
`
  ...
  writeFile(join(config.projectPath, 'commitlint.config.js'), commitlintConfig, {
    dryRun: config.dryRun,
  })
...
`
  ...
  writeFile(join(config.projectPath, '.vscode', 'settings.json'), vsCodeSettings, {
    dryRun: config.dryRun,
  })
...
`
  ...
  writeFile(join(config.projectPath, '.vscode', 'extensions.json'), vsCodeExtensions, {
    dryRun: config.dryRun,
  })
